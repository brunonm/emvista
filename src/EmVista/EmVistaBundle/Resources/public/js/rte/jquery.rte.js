...
<ul class="nav navigation-rte ">\n\
    <li style="font-weight: bold" class="bold">\n\
        <a href="#" >\n\
            Negrito\n\
        </a>\n\
    </li>\n\
    <li style="font-style: italic" class="italic">\n\
        <a href="#" >\n\
            Itálico\n\
        </a>\n\
    </li>\n\
    ...
    <li class="normal">\n\
        <a href="#" >\n\
            ...
            $('.p',tb).click(function(){
                $('.select',tb).val('p').trigger('change');
                return false;
            })
            $('.h3',tb).click(function(){
                $('.select',tb).val('h3').trigger('change');
                return false;
            })
            $('.normal',tb).click(function(){
                $('.select',tb).val('').trigger('change');
                return false;
            })
