...
<div class="row">
    <div class="col-sm-2">
        <div class="row">
            <div class="col-sm-12 userImageProfile">
                <a href="#" >
                    <img src="<?php echo $usuario->getImageProfileWebPath()?>" class="img-circle" alt="<?php echo $usuario->getNome()?>">

                </a>
                <a href="javascript:;" class="alterarImagem" data-toggle="modal" data-target="#modalUploadImagem">
                    Alterar Imagem
                </a>
            </div>
        </div>
...
<?php $view['slots']->start('modal') ?>
    <div class="modal fade" id="modalUploadImagem">
